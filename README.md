...
*  **Mock Market Streamer:** Generates synthetic tick data mimicking a live API. Simulates stock price movement using Geometric Brownian Motion (Gaussian returns generating Lognormal prices) and mimics the volatile Bid-Ask spreads characteristic of low-volume, mid-cap equities.
* **Portfolio Manager:** Tracks real-time cash balances, calculates cost bases using weighted averages, and tracks realized profits and losses for individual arbitrage trades.
